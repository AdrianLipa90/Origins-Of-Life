...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="exotic_persistence_artifact")
    ...
    rows = [
        result.as_record()
        for result in run_matched_compartment_persistence(
    ...
    json_path = outdir / "exotic_compartment_persistence_v01.json"
    csv_path = outdir / "exotic_compartment_persistence_v01.csv"
