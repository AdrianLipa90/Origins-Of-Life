...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="hydrocarbon_information_diffusion_ablation_artifact")
    ...
    rows = [
        row.as_record()
        for row in run_information_diffusion_ablation(
            SCENARIO_D,
            seeds=args.seeds,
    ...
    json_path = outdir / "hydrocarbon_information_diffusion_ablation_v01.json"
    csv_path = outdir / "hydrocarbon_information_diffusion_ablation_v01.csv"
