...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="hydrocarbon_stability_factorial_artifact")
    ...
    rows = [
        row.as_record()
        for row in run_hydrocarbon_stability_factorial(
            SCENARIO_D,
            seeds=args.seeds,
    ...
    json_path = outdir / "hydrocarbon_stability_factorial_v05.json"
    csv_path = outdir / "hydrocarbon_stability_factorial_v05.csv"
