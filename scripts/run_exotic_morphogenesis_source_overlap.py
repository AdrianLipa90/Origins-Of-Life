...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="exotic_morphogenesis_artifact")
    ...
    rows = [
        result.as_record()
        for result in run_matched_morphogenesis_source_overlap(
    ...
    json_path = outdir / "exotic_morphogenesis_source_overlap_v01.json"
    csv_path = outdir / "exotic_morphogenesis_source_overlap_v01.csv"
