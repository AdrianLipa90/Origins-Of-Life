...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="exotic_reachability_artifact")
    ...
    rows = [
        result.as_record()
        for result in run_matched_threshold_reachability(
    ...
    json_path = outdir / "exotic_threshold_reachability_v01.json"
    csv_path = outdir / "exotic_threshold_reachability_v01.csv"
