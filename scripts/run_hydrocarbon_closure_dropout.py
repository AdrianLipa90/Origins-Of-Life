...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="hydrocarbon_dropout_artifact")
    ...
    json_path = outdir / "hydrocarbon_closure_dropout_v01.json"
    csv_path = outdir / "hydrocarbon_closure_dropout_v01.csv"
