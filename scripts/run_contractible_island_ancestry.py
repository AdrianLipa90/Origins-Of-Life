...
from origins.exobiology.contractible_island_ancestry import (
    ancestry_manifest,
    run_matched_contractible_island_ancestry,
)
...
def main() -> int:
    ...
    parser.add_argument("--outdir", default="contractible_island_ancestry_artifact")
    ...
    rows = [
        row.as_record()
        for row in run_matched_contractible_island_ancestry(
            SCENARIO_D,
            seeds=args.seeds,
    ...
    json_path = outdir / "contractible_island_ancestry_v01.json"
    csv_path = outdir / "contractible_island_ancestry_v01.csv"
