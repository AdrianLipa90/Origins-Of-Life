...
from origins.analysis.sweep_orbital import run_topo_sweep_orbital
from origins.scenarios import ALL_SCENARIOS, SCENARIOS_BY_CODE


def main() -> None:
    parser = argparse.ArgumentParser(description="Run native orbital topo sweep")
    parser.add_argument("--scenarios", nargs="*", default=None)
    parser.add_argument("--nx", type=int, default=64)
    parser.add_argument("--ny", type=int, default=64)
    parser.add_argument("--dt", type=float, default=0.05)
    parser.add_argument("--hours", type=float, default=60.0)
    parser.add_argument("--outdir", type=str, default="outputs_native_orbital_sweep")
